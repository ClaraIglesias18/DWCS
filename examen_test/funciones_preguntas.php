...
function crear_pregunta($conexion, $enunciado, $op_a, $op_b, $op_c, $correcta) {
    $sql = "INSERT INTO preguntas (enunciado, op_a, op_b, op_c, correcta) VALUES (?, ?, ?, ?, ?)";
    $stmt = mysqli_prepare($conexion, $sql);
    mysqli_stmt_bind_param($stmt, "sssss", $enunciado, $op_a, $op_b, $op_c, $correcta);
