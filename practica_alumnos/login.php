...
if (isset($_SESSION['msg'])) {
    ...
    $msg = "Introduce tus credenciales para acceder.";
}

if (isset($_COOKIE['recordar_username'])) {
    $ussername_recordar = $_COOKIE['recordar_username'];
    $password_recordar = $_COOKIE['recordar_password'];
} else {
    $ussername_recordar = "";
    $password_recordar = "";
}
        ...
        <div class="form-container">
            ...
            <form action="procesar_usuarios.php" method="POST">
                ...
                <div class="input-group">
                    ...
                    <input type="text" id="username" name="username" placeholder="<?= $ussername_recordar; ?>" required>
                </div>

                <div class="input-group">
                    <label for="password">Contraseña</label>
                    <input type="password" id="password" name="password" placeholder="<?= $password_recordar; ?>" required>
                </div>

                <div class="input-group">
                    <label>
                        <input type="checkbox" name="recordar" style="width: auto;"> Recordarme</label>
                </div>
