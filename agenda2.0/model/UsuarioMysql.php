...
class UsuarioMysql extends Usuario implements iUsuario
{
    ...
    public function getById($id)
    {
        ...
        $usuario = new self($result->id_usuario, $result->nombre, $result->correo, $result->password);
    ...
    public function comprobarUsuario($correo, $password)
    {
        ...
        $result = $stm->fetchAll(PDO::FETCH_OBJ)[0];
        $usuario = new self ($result->id_usuario, $result->nombre, $result->correo, $result->password, $result->rol);
