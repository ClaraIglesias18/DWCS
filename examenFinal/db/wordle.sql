CREATE DATABASE  IF NOT EXISTS `wordle` /*!40100 DEFAULT CHARACTER SET latin1 */;
USE `wordle`;
-- MySQL dump 10.13  Distrib 8.0.29, for Win64 (x86_64)
--
-- Host: 127.0.0.1    Database: wordle
-- ------------------------------------------------------
...
INSERT INTO `palabra` VALUES (1,'ganar'),(2,'cimas'),(3,'filon'),(4,'rimas'),(5,'rifas');
...
-- Dump completed on 2023-04-20 16:37:31
