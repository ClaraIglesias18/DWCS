...
<head>
    ...
    <title>Únete a Cinefilia - Registro</title>
    <style>
        :root {
            --primary: #e74c3c;
            --dark: #1a1a1a;
...
<body>
    ...
    <div class="auth-card">
        ...
        <?php endif; ?>
        <p style="text-align: center; color: #666; font-size: 0.9em;">Únete para valorar tus películas favoritas</p>
        ...
        <form action="procesar.php" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="text" id="usuario" name="usuario" required placeholder="Ej: nolan_fan">
            </div>
